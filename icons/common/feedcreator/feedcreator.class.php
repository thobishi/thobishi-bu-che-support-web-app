...
//		return "<!-- generator=\"".FEEDCREATOR_VERSION."\" -->\n";
	...
	function _createStylesheetReferences() {
		$xml = "";
		if ($this->cssStyleSheet) $xml .= "<?php xml-stylesheet href=\"".$this->cssStyleSheet."\" type=\"text/css\"?>\n";
		if ($this->xslStyleSheet) $xml .= "<?php xml-stylesheet href=\"".$this->xslStyleSheet."\" type=\"text/xsl\"?>\n";
		return $xml;
	}
...
class RSSCreator10 extends FeedCreator {
	 ...
	 */
	function createFeed() {     
		$feed = "<?php xml version=\"1.0\" encoding=\"".$this->encoding."\"?>\n";
