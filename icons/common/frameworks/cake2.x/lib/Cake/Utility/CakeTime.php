 ...
 */
	public static function fromString($dateString, $timezone = null) {
		...
		$containsDummyDate = (is_string($dateString) && substr($dateString, 0, 10) === '1970-01-01');
 ...
 *   CakeTime::format('1970-01-01', '%d-%m-%Y', 'N/A'); // return N/A becuase an invalid date was passed
