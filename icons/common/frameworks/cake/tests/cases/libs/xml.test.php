 ...
 */
	...
	function testParsingWithNonStandardWhitespace() {
		$raw = '<?php xml version="1.0" encoding="ISO-8859-1" ?><prices><price>1.0</price></prices>';
 ...
 **/
	function testElementCollapsing() {
		...
		$Xml = new Xml();
		$Xml->load('<?php xml version="1.0" encoding="UTF-8" ?>' . $xmlDataThatFails);
 ...
 */
	function testToArray() {
		App::import('Set');
		$string = '<?php xml version="1.0" encoding="UTF-8" standalone="yes"?>
		<rss version="2.0">
		<channel>
 ...
 */
	function testMemoryLeakInConstructor() {
		...
		$data = '<?php xml version="1.0" encoding="UTF-8"?><content>TEST</content>';
