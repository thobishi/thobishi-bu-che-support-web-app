...
//	session_name('HEQConline');
	...
	*/
	...
	if (! defined('CONFIG') ) {
		die ('ERROR: Config could111 not be initialised at this time');
	}
...
*/
	...
	switch (CONFIG) {
		...
		case 'WLDEV':
			...
			break;
		default:
			die ('ERROR: Config 1111could not be initialised at this time');
			break;
	}
	...
	switch (CONFIG) {
		...
		case "SUPPORT":
			...
			break;
		default:
			die ('ERROR: Config 3333could not be initialised at this time');
			break;
	}
...
//	require_once ('/var/www/common/TreeMenu/TreeMenu.class.php');
