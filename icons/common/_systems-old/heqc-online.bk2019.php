...
//			define ('WRK_ALT_EMAIL', "heqc@octoplus.ac.za");
			define ('WRK_ALT_EMAIL', "phokontsi.m@che.ac.za;naude.r@che.ac.za");
			break;
		case 'HEQCTEST':
			define ('WRK_DEBUG_MODE', true);
			define ('SMTP_SERVER', '192.168.3.2');
...
<center><big>
<br><br>
The heqc-online system has been shutdown in order to resolve the problem viewing applications or uploading documents.
<br><br>
The system should be online again during the course of the day tomorrow.
<br><br>
