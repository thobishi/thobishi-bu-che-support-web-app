<?
	...
	$select = "*";
	$whereArray = array('directorate_ref <> 0','project_full_title <> ""','category_ref = 2');
	...
	echo '</tr>';
	echo '<tr class="oncolourb"><td colspan="3">List of Activities for CHE</td><td align="right" width="10%"><b>Total: '.$numOfRows.'</b></td></tr>'."\n";
...
//		$proj_code	 		 = $row["proj_code"];
		...
		echo "<td valign='top' width='2%'><a href='javascript:setProj(\"".$row["project_id"]."\");moveto(\"_startEditActivitiesDetailForm\");'><img border=\'0\' src=\"images/ico_change.gif\"></a></td>\n";
