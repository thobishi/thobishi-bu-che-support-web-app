<?
	...
	$select = "*";
	$whereArray = array('directorate_ref <> 0','project_full_title <> ""', 'category_ref = 1');
	...
	echo '</tr>';
	echo '<tr class="oncolourb"><td colspan="3">List of Projects for CHE</td><td align="right" width="10%"><b>Total: '.$numOfRows.'</b></td></tr>'."\n";
...
//		$proj_code	 		 = $row["proj_code"];
		...
		echo "<td valign='top'><a href='javascript:setProj(\"".$row["project_id"]."\");moveto(\"_startEditProjectDetailForm\");'><img border=\'0\' src=\"images/ico_change.gif\"></a></td>\n";
