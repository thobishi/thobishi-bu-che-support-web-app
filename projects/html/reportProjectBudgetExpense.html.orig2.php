...
<?
	...
	$budget_year   = (isset($_POST['budget_year']) && $_POST['budget_year'] != "") ? $_POST['budget_year'] : $curr_budget_year;
...
<tr>
	...
	<td>
		<?
//add month/project source
			//$doc = new octoDocGen ("projectBudget", "budget=".$budget_year."&proj_source=".$project_source."&month=".$month);
			$doc = new octoDocGen ("projectBudget", "budget=".$budget_year."&proj_source=".$project_source);
