...
$category = dbConnect::getValueFromTable("lkp_project_categories", "category_id",2 , "category_desc");
?>
...
<tr><td>
	...
	<tr>
		<td align="right" valign="top"><b>Activity short title:</b></td>
		<td class="oncolourb">
			<table>
				<tr><td><i>Short activity titles are required to enable the finance department to <b>list activities on financial statements</b>. These statements are being done on Excel-spreadsheets and long titles take up too much space. Find a short title that will <b>minimise the risk of confusion</b> with other short activity titles. Avoid the use of acronyms as far as possible.</i></td></tr>
				<tr><td><?	$this->showField("project_short_title");	?></td></tr>
			</table>
		</td>
	</tr>
	<tr>
		<td align="right" valign="top"><b>Activity full title:</b></td>
		<td class="oncolourb">
			<table>
				<tr><td><i>The activity title must reflect the <b>key purpose and scope of the activity</b>. It has to be detailed enough to ensure that the activity is not easily confused with other CHE activities. Avoid the use of acronyms as far as possible.</i></td></tr>
...
?>
	...
	<tr>
		<td align="right"><b>Key processes and/or phases:</b></td>
		<td class="oncolourb"><?php echo $this->showField("key_processes_phases") ?></td>
	</tr>
	<tr>
	...
	<tr>
				<td colspan="2">
				<?
						$this->formFields["category_ref"]->fieldValue = 2;
