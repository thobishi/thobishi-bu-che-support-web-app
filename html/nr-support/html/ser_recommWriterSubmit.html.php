...
<?php
	...
	$recommendation_end_date = $this->db->getValueFromTable("nr_programmes","id",$prog_id ,"recommendation_end_date");
...
<div class ="span6">
	...
	<p class="text-warning">
		You have until <?php echo '<strong>'. $recommendation_end_date .' 23:59 </strong>'; ?> to make amendments.
	</p>
	<p>
