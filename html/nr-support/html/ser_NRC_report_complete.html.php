<h3>Upload upload National Review Committee report - Finish</h3>
<div class="row-fluid">
<?php
...
<?php
	echo "The process 'Upload National Review Committee report' is now complete. Click on '<strong>Next</strong>' to proceed to the next user and process.";
?>
</div>