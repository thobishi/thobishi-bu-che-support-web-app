...
<div class="hero-unit">
	...
	<p>
		The recommendation writer must logon to the system to access the SER, the Reports from the Desktop evaluators and the Panel. A recommendation writer's report template is also available and should be completed and then uploaded, The report will display below once they have uploaded it
		<ul>
			<li>
