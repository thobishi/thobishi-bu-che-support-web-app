...
<div class="hero-unit">
	...
	<p>
		The desktop evaluator must logon to the system to access the SER, the desktop evaluation template and to upload their completed report. The report will display below once the have uploaded it.
		<ul>
			<li>
				The SER is accessible to the desktop evaluator for the access date period only.
			</li>
			<li>
				You may extend the access period by clicking on previous and changing the start and end dates.
			</li>
			<li>
				The desktop evaluator must upload the report on the system. You must follow up with the desktop evaluator if you do not see the report by the required deadline date. If, for some reason, the desktop evaluator cannot upload it, you may upload it on their behalf.
			</li>
		</ul>
	</p>
	<p>
