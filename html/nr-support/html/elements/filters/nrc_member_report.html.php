...
<fieldset class="searchFieldset">
	...
	<?php
		...
		$nr_meeting_start_date = readPOST('nr_meeting_start_date');
		$this->formFields['nr_meeting_start_date']->fieldValue = $nr_meeting_start_date;
		...
		$this->showBootstrapField('nr_meeting_start_date', 'Meeting start date');
