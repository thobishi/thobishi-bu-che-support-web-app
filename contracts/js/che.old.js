...
//Sorts a report by the column that the user clicked on.
//Requires a hidden field report_order in defaultFrm
function setReportOrder(fld){
	document.defaultFrm.report_order.value = fld;
	moveto('stay');
}
