...
<br>
<span class="loud">Forgot Password</span>
<br><br>
...
if (isset($_POST["email"])) {
	...
	$SQL = "UPDATE `users` SET password=PASSWORD('".$passwd."') WHERE email='".$_POST["email"]."'";
	$rs = mysqli_query($SQL);
...
<tr>
	...
	<td>&nbsp;</td>
	<td><input class="btn" type="button" value="Send Password" onClick="javascript:moveto('stay');"></td>
</tr><tr>
	<td colspan="2">&nbsp;</td>
</tr><tr>
	<td colspan="2" align="center">
