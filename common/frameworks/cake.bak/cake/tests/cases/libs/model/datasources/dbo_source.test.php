	...
	function schema() {
		if (!isset($this->_schema)) {
			$this->_schema = array(
				...
				'created' => array('type' => 'datetime', 'null' => false, 'default' => '1970-01-01 00:00:00', 'length' => null),
				'modified' => array('type' => 'datetime', 'null' => false, 'default' => '1970-01-01 00:00:00', 'length' => null)
			);
		}
		return $this->_schema;
	}
