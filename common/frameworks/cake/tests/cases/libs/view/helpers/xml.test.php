 ...
 */
	function testHeader() {
		...
		$expected = '<?php xml version="1.0" encoding="'.$expectedDefaultEncoding.'" ?>';
		$this->assertIdentical($result, $expected);
		...
		$result = $this->Xml->header($attrib);
		$expected = '<?php xml version="1.1" encoding="UTF-8" ?>';
		$this->assertIdentical($result, $expected);
		...
		$result = $this->Xml->header($attrib);
		$expected = '<?php xml version="1.2" encoding="UTF-8" additional="attribute" ?>';
		$this->assertIdentical($result, $expected);

		$attrib = 'encoding="UTF-8" someOther="value"';
		$result = $this->Xml->header($attrib);
		$expected = '<?php xml encoding="UTF-8" someOther="value" ?>';
		$this->assertIdentical($result, $expected);
	}
}
?>