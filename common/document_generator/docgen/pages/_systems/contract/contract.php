...
// 			define('DB_PASSWD',   'Grew2tree');
		...
		case 'CRONRA':
			...
			define ('WRK_DEBUG_MODE', true);
			define ('SYSTEM_APP', '/var/www/html/usr/eb/che-contracts/lib');
			define ('REL_PATH', '/usr/eb/che-contracts/');
			define ('OCTODOC_DIR', '/var/www/html/che/contract/docs-contract/');

			define ('SEC_USER_INTERNAL_IP', '192.168.10');

			define ('OCTODOCGEN_URL', 'http://ra/usr/eb/che-contracts/docgen/');
			define ('SMTP_SERVER', '192.168.3.2');
			error_reporting(E_ALL);
		...
		case 'OCTODEMO':
			define('DB_SERVER',   'localhost');
			define('DB_DATABASE', 'CHE_contract_register_stage');
 			define('DB_USER',     'contract_owner');
 			define('DB_PASSWD',   'Grew2tree');

			define ('SYSTEM_APP', '/var/www/stage/che-contracts/lib');
			define ('REL_PATH', '/');
