...
*/
	...
	switch (CONFIG) {
		...
		case 'LIVE':
			...
			define('OCTODOCGEN_URL', 'https://nr-support.che.ac.za/nr-support/docgen/');
			define('OCTODOC_DIR', '/var/www/html/docs-nr/');

			define('DB_SERVER', 'localhost');
			define('DB_DATABASE', 'nr_supportdb');
			define('DB_USER', 'root');
...
//	require_once ('TreeMenu/TreeMenu.class.php');
	require_once ('/var/www/html/common/phpmailer/class.phpmailer.php');
	require_once ('/var/www/html/common/pdf/phpwkhtmltopdf/WkHtmlToPdf.php');
