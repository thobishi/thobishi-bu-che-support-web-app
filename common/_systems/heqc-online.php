...
//	session_name('HEQConline');
	...
	require_once ('/var/www/html/common/simple/functions.http.php');
	require_once ('/var/www/html/common/simple/class.octoEncrypt.php');
	...
	*/
	...
	if (stristr($url, "127.0.0.1/heqc-online") || stristr($url, "localhost/heqc-online"))
        ...
        define ('CONFIG', 'CHEDEV');


		//if (stristr($url, "https://heqc-upgrade.che.ac.za"))
		//	define ('CONFIG', 'CHEDEVTEST');


        if (stristr($url, "https://heqc-support.che.ac.za"))
...
//var_dump($url); 
	...
	switch (CONFIG) {
               ...
               case 'CHEPROD':
                     ...
                     case 'CHEDEV':
						...
						case 'CHEDEVTEST':
							...
							define ('OCTODOC_DIR', '/var/www/html/heqc-docs/');
							//Remove this
							define ('OCTODOCGEN_URL', 'https://heqc-upgrade.che.ac.za/docgen/');
							define ('ROOT_URL', 'https://heqc-upgrade.che.ac.za/');
	
							define('DB_SERVER',   'localhost');
							define('DB_DATABASE', 'heqsupport_db');
							define('DB_USER',     'root');
							define('DB_PASSWD',   '');
			...
			define ('OCTODOC_DIR', '/var/www/html/heqc-docs/');
			//Remove this
			define ('OCTODOCGEN_URL', 'https://heqc-support.che.ac.za/docgen/');
			define ('ROOT_URL', 'https://heqc-support.che.ac.za/');
...
case 'CHETEST4':
	...
	// general functions
	require_once ('/var/www/html/common/simple/functions.html.php');
	require_once ('/var/www/html/common/simple/functions.escape.php');
	require_once ('/var/www/html/common/simple/functions.xml.php');
//	require_once ('TreeMenu/TreeMenu.class.php');
	require_once ('/var/www/html/common/phpmailer/src/PHPMailer.php');

	// include required system libraries
	
	
	//$commonDir = $_SERVER['DOCUMENT_ROOT'].'common/';
	define ('COMMON_DIR', $_SERVER['DOCUMENT_ROOT'].'var/www/html/common');
	define ('ROOT_DIR', $_SERVER['DOCUMENT_ROOT']);
	require_once ('/var/www/html/common/workflow-1.0/class.dbConnect.php');

	require_once ('/var/www/html/common/workflow-1.0/class.dbFunctions.php');
	require_once ('/var/www/html/common/workflow-1.0/class.security.php');
	require_once ('/var/www/html/common/workflow-1.0/class.createPage.php');
	require_once ('/var/www/html/common/workflow-1.0/class.dbTableInfo.php');
	require_once ('/var/www/html/common/workflow-1.0/class.pageForm.php');
	require_once ('/var/www/html/common/workflow-1.0/class.handleDocs.php');
	require_once ('/var/www/html/common/workflow-1.0/class.flowLogic.php');
	require_once ('/var/www/html/common/workflow-1.0/class.formActions.php');
	require_once ('/var/www/html/common/workflow-1.0/class.formFields.php');
	require_once ('/var/www/html/common/workflow-1.0/class.reports.php');
