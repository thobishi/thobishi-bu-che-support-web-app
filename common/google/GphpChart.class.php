...
class GphpChart 
  ...
  'b' => array('chtt','chbh','chdl','chco','chf','chxt','chxp','chdlp'),
...
/* PRE GENERATION : add labels, data, axis, etc */  
  ...
  {
  $this->cached = false;
  if(isset($values['values_type']) && ($values_type = $values['values_type']))
  {
  ...
  function legend_style($style)
  {
	$this->cached = false;
	$this->chart->chdlp = $style;
  }
