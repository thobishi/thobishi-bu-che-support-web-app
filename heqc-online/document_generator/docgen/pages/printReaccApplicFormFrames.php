<frame src="printReaccApplicForm.php?workflow_settings=<?php echo $_GET["workflow_settings"]?>&title=<?php echo $_GET["title"]?>&appid=<?php echo $_GET["appid"]?>" name="bodyFrame" id="bodyFrame" marginwidth=0 marginheight=0 frameborder=0 noresize scrolling=auto>
...
<?php 
	// Robin: 13 September 2008

	$app->displayReaccApplicFormOverview($application_id, $str)
