...
$reference_code = $app->getValueFromTable("Institutions_application", "application_id", $app_id, "CHE_reference_code");
...
<tr>
	...
	<td align="right" bgcolor="#ECF1F6" >
		...
		<?php 
			$NQF_id = $app->getValueFromTable("Institutions_application", "application_id", $app_id, "NQF_ref");
			if ($NQF_id > 2) {
		?>
		...
		<?php }
			$mode_id = $app->getValueFromTable("Institutions_application", "application_id", $app_id, "mode_delivery");
			$hei_id = $app->getValueFromTable("Institutions_application", "application_id", $app_id, "institution_id");
