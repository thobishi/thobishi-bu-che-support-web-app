...
$this->scriptTail = <<<SCRIPTTAIL
    ...
    if (!valDocRequired(document.defaultFrm.FLD_finance_invoice_doc,'Please upload the invoice to be sent to the institution.'))		{return false;}
