...
SELECT inst_site_visit.institution_ref, HEInstitution.HEI_name, HEInstitution.priv_publ, inst_site_visit.institution_notification_doc,
...
$html = $inst .$Siteapplication . $Notificationletter . $jscripts . $sites . '</td></tr>'. '</table >';
...
REF;
	...
	function reportAlignedApplications($dateFrom='0',$dateTo='0', $institution='0'){	
		...
		//es3
		$aSql ="SELECT HEI_name, CHE_reference_code, program_name AS CHE_programme_name, (SELECT group_concat(old_title) FROM 
