...
<tr>
	...
	<a href="#" onclick="window.parent.frames['bodyFrame'].location.hash='application_form_question3';return false;" title="STAFF">3</a>&nbsp;|&nbsp;
	<a href="#" onclick="window.parent.frames['bodyFrame'].location.hash='application_form_question4';return false;" title="STAFF (continued)">4</a>&nbsp;|&nbsp;
	<a href="#" onclick="window.parent.frames['bodyFrame'].location.hash='application_form_question5';return false;" title="STUDENT ASSESSMENT">5</a>&nbsp;|&nbsp;
	<a href="#" onclick="window.parent.frames['bodyFrame'].location.hash='application_form_question6';return false;" title="VENUES AND IT INFRASTRUCTURE">6</a>&nbsp;|&nbsp;
