<?php 
	if (isset($_POST["cmd"]) && ($_POST["cmd"] > "")) {
		switch ($_POST["cmd"]) {
			case "new":
				$this->saveProgram("institutional_profile_full_equiv_2003", "institution_ref", $this->getValueFromTable("users", "user_id", $this->currentUserID, "institution_ref"));
				break;
			case "del":
				if (isset($_POST["id"]) && ($_POST["id"]>"")) {
					$this->deleteProgram("institutional_profile_full_equiv_2003", "institutional_profile_full_equiv_2003_id", $_POST["id"]);
				}
				break;
			default:
				break;
	...
	$table = $this->createAcaStruct("institution_ref", $this->getValueFromTable("users", "user_id", $this->currentUserID, "institution_ref"), "institutional_profile_full_equiv_2003", "institutional_profile_full_equiv_2003_id", $fieldsArr, 5, 0, $tableHeading);
?>
