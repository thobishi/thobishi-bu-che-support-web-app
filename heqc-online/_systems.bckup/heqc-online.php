...
//	session_name('HEQConline');
	...
	*/
	...
	if (stristr($url, "127.0.0.1/heqc-online") || stristr($url, "localhost/heqc-online"))
		...
		if (stristr($url, "http://129.232.234.108/heqc-online/"))
			define ('CONFIG', 'CHEPRODTEST');
              ...
              //PRODUCTION SERVER
               ...
               case 'CHEPROD':
						...
						case 'CHEPRODTEST':
							...
							define ('OCTODOC_DIR', '/var/www/heqc-docs/');
							//Remove this
							define ('OCTODOCGEN_URL', 'http://129.232.234.108/heqc-online/docgen');
							define ('ROOT_URL', 'http://129.232.234.108/heqc-online/');
