...
<tr>
	<td colspan="4"><span class="loud">Report of accreditation withdrawn applications submitted to the HEQC via the HEQC-online system:</span></td>
</tr>
...
<tr>
	...
	<td>
		<input type="submit" class="btn" name="submitButton" value="Search" onClick="javascript:moveto('_report_reportAccrediationWithdrawnApplications');">
	</td>
</tr>
</table>
<br>
...
if (isset($_POST['dateFrom'])){
	...
	$this->reportAccrediationWithdrawnApplications($dateFrom,$dateTo,$institution);
