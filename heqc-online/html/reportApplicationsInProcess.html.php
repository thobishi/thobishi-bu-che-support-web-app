...
<tr>
	<td colspan="4"><span class="loud">Report of applications in process submitted to the HEQC via the HEQC-online system:</span></td>
</tr>
...
<tr>
	...
	<td>
		<input type="submit" class="btn" name="submitButton" value="Search" onClick="javascript:moveto('_report_reportApplicationsInProcess');">
	</td>
</tr>
</table>
<br>
...
if (isset($_POST['dateFrom'])){
	...
	$this->reportApplicationsInProcess($dateFrom,$dateTo,$institution);
