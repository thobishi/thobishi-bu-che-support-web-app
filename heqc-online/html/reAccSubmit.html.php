...
<table width="95%" border=0 align="center" cellpadding="2" cellspacing="2">
	...
	<tr>
		<td>
			...
			<br><br>Please use the following reference number in all future queries: <b><?php echo $this->getFieldValue("referenceNumber")?></b>
...
<script>
	var printed = '<?php echo $this->getValueFromTable("Institutions_application_reaccreditation", "Institutions_application_reaccreditation_id", $current_id, "reacc_applic_printed");?>';
</script>
