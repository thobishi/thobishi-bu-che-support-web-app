...
?>
		...
		<tr align="center" class='oncolourb'>
			<td width="30%">&nbsp;</td>
			<td colspan="2">Black</td>
			<td colspan="2">Coloured</td>
...
<?php
	...
	//  institutional_profile_other_sites_info
	//$headArr = array();
	//$headArr["Name"] = "1";
	//$headArr["Location"] = "1";
	...
	//echo $this->gridDisplayPerTable("institutional_profile", "institutional_profile_other_sites_info", "institutional_profile_other_sites_info_id", "institution_ref",$fieldsArr, 5, 0, $headArr);
?>
<?php
/*	$headArr = array();
	array_push($headArr, "Site of Delivery");
	array_push($headArr, "Location");
	array_push($headArr, "Undergraduate");
	array_push($headArr, "Postgraduate");
...
//	array_push($headArr, "% Learning Time");
	...
	$evalArr = array();
	array_push($evalArr, "site_name");
	
	$fieldsArr = array();
	array_push($fieldsArr, "location");
	array_push($fieldsArr, "enrol_under_contact");
	array_push($fieldsArr, "enrol_post_contact");
	$inst_ref = $this->getValueFromTable("users", "user_id", $this->currentUserID, "institution_ref");
*/ 
?>
