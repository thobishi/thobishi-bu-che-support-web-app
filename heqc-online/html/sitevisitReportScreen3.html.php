...
<table><tr>
	...
	<td colspan="2" valign="top"><?php echo nl2br($this->getValueFromTable("evalSiteVisitReport", "evalSiteVisitReport_id", $this->dbTableInfoArray["evalSiteVisitReport"]->dbTableCurrentID, "3_eval_question_1")) ?></td>
</tr><tr>
	...
	<td colspan="2" valign="top"><?php echo nl2br($this->getValueFromTable("evalSiteVisitReport", "evalSiteVisitReport_id", $this->dbTableInfoArray["evalSiteVisitReport"]->dbTableCurrentID, "3_eval_question_2")) ?></td>
</tr><tr>
	...
	<td colspan="2" valign="top"><?php echo nl2br($this->getValueFromTable("evalSiteVisitReport", "evalSiteVisitReport_id", $this->dbTableInfoArray["evalSiteVisitReport"]->dbTableCurrentID, "3_eval_question_3")) ?></td>
</tr><tr>
	...
	<td colspan="2" valign="top"><?php echo nl2br($this->getValueFromTable("evalSiteVisitReport", "evalSiteVisitReport_id", $this->dbTableInfoArray["evalSiteVisitReport"]->dbTableCurrentID, "3_eval_question_4")) ?></td>
</tr></table>
<br><br>
