...
<tr>
	...
	<td><?php $this->showField("referenceNumber");?></td>
</tr>
<tr>
	<td width="50%"><b>Programme name:</b></td>
	<td><?php $this->showField("programme_name");?></td>
</tr>
<tr>
	<td width="50%"><b>NQF level:</b></td>
	<td><?php $this->showField("NQF_level");?></td>
</tr>
<tr>
	<td width="50%"><b>Number of Credits:<b></td>
	<td><?php $this->showField("saqa_credits");?></td>
</tr>
<tr>
	<td width="50%"><b>Minimum duration (years) for completion - Full Time:</b></td>
	<td><?php $this->showField("full_time_duration") ?></td>
</tr>
<tr>
	<td width="50%"><b>Minimum duration (years) for completion - Part Time:</b></td>
	<td><?php $this->showField("part_time_duration") ?></td>
</tr>
<tr>
...
<tr>
	...
	<td><?php $this->showField("qualification_type_ref") ?></td>
</tr>
...
<tr>
	<td width="50%"><b>CESM Classification (e.g. Education):</b></td>
	<td><?php $this->showField("CESM_code1") ?></td>
</tr>

<tr>
	<td width="50%"><b>First Qualifier (e.g. 0703 - Education Management and Leadership):</b></td>
	<td><?php $this->showField("CESM_level2_ref") ?></td>
</tr>

<tr>
	<td width="50%"><b>Second Qualifier (e.g. 070305 Higher Education):</b></td>
	<td><?php $this->showField("CESM_level3_ref") ?></td>
</tr>
<tr>
	<td colspan="2">
		<!--SAQA fields-->
		...
		<td valign="top"><?php $this->showField("is_reg_saqa_nqf") ?></td>
		</tr>
				...
				<div id="is_reg_saqa_nqf" style="display:<?php echo $displayStyle?>">
					<table cellpadding="2" cellspacing="2" align="right" width="100%">
						<tr>
							...
							<td><?php $this->showField("saqa_reg_nr") ?></td>
						</tr>
						<tr>
							<td width="50%"><b>Please enter the date of registration with SAQA:</b></td>
							<td><?php $this->showField("saqa_reg_date") ?></td>
						</tr>
					</table>
				</div>
			</td>
				...
				<div id="is_reg_saqa_nqf2" style="display:<?php echo $displayStyle?>">
						<table cellpadding="2" cellspacing="2" align="right" width="100%">
							<tr>
								...
								<td><?php $this->showField("saqa_appl_date") ?></td>
							</tr>
						</table>
				</div>
			</td>
