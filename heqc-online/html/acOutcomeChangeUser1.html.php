...
<tr>
	<td>
	Once you have completed your part, send it to the next person that needs to be involved in the process. 
	To do this, select an email address from the list below:<br><br>
	<b>Colleague: </b>
<?php
