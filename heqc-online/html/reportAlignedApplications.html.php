...
<tr>
	<td colspan="4"><span class="loud">Report of Aligned Applications submitted to the HEQC via the HEQC-online system:</span></td>
</tr>
...
<tr>
	...
	<td>
		<input type="submit" class="btn" name="submitButton" value="Search" onClick="javascript:moveto('_report_reportAlignedApplications');">
	</td>
</tr>
</table>
<br>
...
$this->formFields["institution"]->fieldValue = $this->getValueFromTable ("users", "user_id", $this->currentUserID, "institution_ref");

$this->reportAlignedApplications($dateFrom,$dateTo,$this->formFields["institution"]->fieldValue );
...
if (isset($_POST['dateFrom'])){
	...
	$this->reportAlignedApplications($dateFrom,$dateTo,$institution);
