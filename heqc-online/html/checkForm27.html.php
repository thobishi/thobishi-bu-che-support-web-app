...
<?php 
	...
	if (isset($_POST["FLD_email_rcpt"]) && ($_POST["FLD_email_rcpt"] > "")) {
		$message = $this->getTextContent ("checkForm27", "ProfessionalProgramme");
		$this->misMailByName($_POST["FLD_email_rcpt"], "Professional association clearance", $message);
	}
...
?>
	<table><tr>
		...
		<td>Did you receive the proof of the relevant professional association clearance of the programme back from the institution? <?php $this->showField("results_back");?> <i>(Tick for yes)</i></td>
	</tr><tr>
		<td>If you did, please tick it off <i>(above)</i> and click "Next" to continue.</td>
	</tr></table>
	<script>
...
?>
	<table><tr>
		...
		<td colspan="2">
<?php 
		$this->showEmailAsHTML("checkForm27", "ProfessionalProgramme");
...
<tr>
	<td>To override this message check this box: <?php $this->showField("override_email_send");?></td>
</tr>
<tr>
	<td>
		...
		<table><tr>
			...
			<?php $this->showField("override_message_email_reason");?>
			</td>
		</tr></table>
		</div>
	</td>
...
try {
	...
	if ((document.defaultFrm.FLD_override_email_send.checked) && (document.getElementById('override_div').style.display = "none")) {
		showHide (document.getElementById('override_div'));
	}
}catch(e){}
</script>
