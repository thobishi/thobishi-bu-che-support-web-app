...
<?php 
$this->showField("cancelPaymentgotoInst");
?>
<br>
<table width="95%" border=0 align="center" cellpadding="2" cellspacing="2">
<tr>
	<td>
	<b>The payment for this application is going to be cancelled and the application
...
<script>
	function checkComment () {
		...
		document.defaultFrm.cancelPaymentgotoInst.value = 1;
		return true;
	}
</script>