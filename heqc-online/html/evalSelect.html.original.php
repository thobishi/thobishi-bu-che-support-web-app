...
<tr>
	...
	<tr>
		<td>
			...
			<br>
			<IFRAME width="100%" id="resultsFrame" name="resultsFrame" src="" style="height:200;width:500"></IFRAME>
		</td>
	</tr>
	</table>
...
<tr>
	...
	<?php
		...
		$this->gridShowRowByRow("evalReport","evalReport_id","application_ref__".$current_id,$dFields,$hFields, 40, 5, "", "true");
	?>
	</table>
	</td>
</tr>
