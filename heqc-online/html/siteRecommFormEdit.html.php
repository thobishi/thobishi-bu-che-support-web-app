<?php
	...
	switch ($this->flowID){
	case '179':
		$this->createAction ("cancel", "Cancel without saving", "href", "javascript:cancelView('_siteRecommForm_prelim');", "ico_cancel.gif");
		break;
	case '180':
		$this->createAction ("cancel", "Cancel without saving", "href", "javascript:cancelView('_siteRecommForm_inter');", "ico_cancel.gif");
		break;
	case '181':
		$this->createAction ("cancel", "Cancel without saving", "href", "javascript:cancelView('_siteRecommForm_final');", "ico_cancel.gif");
		break;
	case '184':
		$this->createAction ("cancel", "Cancel without saving", "href", "javascript:cancelView('_siteRecommForm_portal');", "ico_cancel.gif");
		break;
	}

	$main_title = 'Directorate recommendation';
	$instr = 'Please complete the directorate recommendation for the following site:';
	$decision_fld = 'site_recomm_decision_ref';
	$table = "inst_site_visit_recomm_decision";
	$key = "inst_site_visit_recomm_decision_id";
