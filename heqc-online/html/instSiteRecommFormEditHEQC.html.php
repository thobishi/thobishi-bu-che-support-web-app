<?php
	...
	switch ($this->flowID){
	case '187':
		$this->createAction ("cancel", "Cancel without saving", "href", "javascript:cancelView('_instSiteHEQCOutcome2');", "ico_cancel.gif");
		break;
	}

	$main_title = 'HEQC recommendation';
	$instr = 'Please update the HEQC decision for the following site:';
	$decision_fld = 'site_heqc_decision_ref';
	$table = "inst_site_visit_heqc_decision";
	$key = "inst_site_visit_heqc_decision_id";
