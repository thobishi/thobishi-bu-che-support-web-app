			...
			<table border='0' width="95%" cellpadding="2" cellspacing="2" align="center">
				<tr>
					<td class="oncoloursoft" align="right" colspan="5">
						<?php if ($this->view != 1){?>
						<a href="javascript:reaccredDoc('NEW');moveto('_label_documentBasketForm');">>> Add new document</a>
						<?php }?>
					</td>
				</tr>
				<tr>
...
SQL;
			...
			if (mysqli_num_rows($rs) > 0) {
				while ($row = mysqli_fetch_array($rs)) {
					...
					$link = "Edit";
					if ($this->view != 1){
						$link = '<a href="javascript:reaccredDoc('.$doc_id.');moveto(\'_label_documentBasketForm\');">Edit</a>';
					}
					$docHtml .=<<< TEXT
						<tr>
