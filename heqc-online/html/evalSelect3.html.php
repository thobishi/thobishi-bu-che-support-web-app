...
<tr>
	<td align="center">
	<br>
	<b>Indicate who of the following evaluators have accepted to take part in the programme evaluation:</b>
	<table width="70%" border=0 align="center" cellpadding="2" cellspacing="2">
		<?php 

		//Changing evaluation to proceedings
		//$unique_flds = "application_ref__".$app_id;
		$unique_flds = "ia_proceedings_ref__".$app_proc_id;

		$headingArray = array();
		array_push($headingArray,"Evaluator");
		array_push($headingArray,"Confirmed");
		array_push($headingArray,"Allow other evaluators to view report<br>in the evaluators portal");
		...
		array_push($fieldArr, "type__radio|name__view_by_other_eval_yn_ref|description_fld__lkp_yn_desc|fld_key__lkp_yn_id|lkp_table__lkp_yes_no|lkp_condition__1|order_by__lkp_yn_desc");
