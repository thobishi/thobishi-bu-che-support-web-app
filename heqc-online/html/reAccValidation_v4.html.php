...
// 						array("reAccForm3","2.1 PROGRAMME DETAILS"),
	...
	$forms = array(array("reAccForm2_v4"," PROGRAMME NAME, LEVEL, SAQA CREDITS AND REGISTRATION"),
						array("reAccForm6_v4","TEMPLATES"),
						);
...
?>
 		<tr>
			<td class="oncolour" colspan="3"><b><?echo $form[1];?></b></td>
		</tr>
<?php
...
<script>
	...
	document.defaultFrm.VALIDATION.value = '_labelReaccreditationValidation_v4';
</script>
</td></tr></table>
<br><br>
