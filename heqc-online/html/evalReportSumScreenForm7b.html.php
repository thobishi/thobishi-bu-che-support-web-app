...
<?php 
	...
	$this->gridShowTableByRow("application_summery_comments", "application_sum_id", "application_sum_id__".$this->dbTableInfoArray["application_summery_comments"]->dbTableCurrentID, $fieldArr, $headArr, 70, 10);
?>
	</td>
</tr></table>
<br><br>
