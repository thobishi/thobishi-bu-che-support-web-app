...
require_once "/var/www/html/heqc-online/document_generator/cl_rtf_driver.php";
require_once "/var/www/html/heqc-online/document_generator/cl_pdf_driver.php";
...
// CONSTRUCTOR
	...
	function nDOCGEN($template,$driver) { 
		self::__construct($template,$driver);
