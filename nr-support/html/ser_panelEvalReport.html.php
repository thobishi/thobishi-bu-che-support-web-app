...
<table class="table table-bordered  screeningTable">
	...
	<tr>
		...
		<td class="fieldsetData">
			...
			<?php 
				$this->makeLink("chair_report_doc", "Preliminary Evaluation Report","","", "","chair_report_date_uploaded");
...
<tr>
		...
		<td class="fieldsetData">
			<fieldset><legend>Upload the Final Evaluation Report</legend>
			<?php 
				$this->makeLink("additional_doc", "Final Evaluation Report");
