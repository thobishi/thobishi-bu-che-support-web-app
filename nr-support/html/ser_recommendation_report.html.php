<h3>Process recommendation - Manage reports</h3>
<div class="row-fluid">
<?php
...
<div class="hero-unit">
	...
	<p>
		The recommendation writer must logon to the system to access the SER, the Reports from the virtual site visitors and the Panel. A recommendation writer's report template is also available and should be completed and then uploaded, The report will display below once they have uploaded it
		<ul>
			<li>
	...
	<p>
		<?php $this->makeLink("recommendation_report_doc", "Submit report on behalf of Recommendation writer","","", "","recommendation_report_date_uploaded");
		?><span class="infoSmall">(Should be uploaded by the report writer but if they email it you may upload it here)</span>
	</p>
</div>
