<h3>Process upload HEQC recommendation - Manage reports</h3>
<div class="row-fluid">
<?php
...
<div class="hero-unit">
	...
	<p>
		<?php $this->makeLink("heqc_recommendation_report_doc", "Upload Recommendation Report to the HEQC","","", "","heqc_recommendation_report_date_uploaded");
		?>
	</p>
</div>