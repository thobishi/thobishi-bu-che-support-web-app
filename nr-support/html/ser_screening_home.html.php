...
<table class="table table-bordered  screeningTable">
	<tr>
		...
		<td class="fieldsetData">
			...
			<img src="html_images/DOC.png" alt="link_image"/><a href="html_documents/Revised Doctoral Screening Form 2020.docx" target="_blank">Download the 			template</a>
			<a class="col-md-2" target="_blank" href="html_documents/BSW Checklist_Form 2023.docx"><img src="images/DOC.png" alt="DOC" />&nbsp;NSAR SUBMISSION SCREENING FORM </a><br/><br/>
			</fieldset>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="fieldsetData sign-off">
			...
			<?php
				...
				// echo '<input type="hidden" name="return_to_institution_email" />';
				?>
			</fieldset>
		</td>
	</tr>
