...
require_once ('/var/www/html/heqc-online/document_generator/cl_xml2driver.php');
...
//array_push($page->scriptFile, "js/jquery-1.10.1.min.js");
//array_push($page->scriptFile, "https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js");
//array_push($page->scriptFile, "https://ajax.googleapis.com/ajax/libs/jquery/3.8.7/jquer.min.js");
array_push($page->scriptFile, "https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js");
...
$page->createAction("home", "Home Page", "href", "javascript:moveto(1);", "");
